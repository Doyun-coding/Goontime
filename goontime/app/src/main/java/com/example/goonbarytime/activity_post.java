...
public class activity_post extends AppCompatActivity implements View.OnClickListener {
    ...
    private EditText post_title, post_contents;
    ...
    public void onClick(View v) {
        if (mAuth.getCurrentUser() != null) {
            ...
            data.put(FirebaseID.title , post_title.getText().toString());
            data.put(FirebaseID.contents , post_contents.getText().toString());
